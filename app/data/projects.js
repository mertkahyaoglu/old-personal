var projects = [
  ...
  {
      "title" : "Atom Video",
      "description" : "Video chat package for Atom Editor. Allows developers to communicate with each other visually.",
  ...
  },
  {
      ...
      "description" : "The aim of the project is to determine how people are feeling when they share tweets. The program classifies only Turkish tweets.",
  ...
  },
  {
      ...
      "android" : "https://play.google.com/store/apps/details?id=com.mertkahyaoglu.brainballs.android",
  ...
  {
      "title" : "Random Movie",
      "description" : "This is a fun project for movie addicts that are not able to find a movie to watch. The project includes REST-API(Node), Angular webpage and Android app.",
      "link" : "https://random-movie.github.io/",
      "github" : "https://github.com/random-movie",
      "android" : "https://play.google.com/store/apps/details?id=com.mertkahyaoglu.randommovie",
  ...
  {
      "title" : "Node Modules",
      "description" : "Node Modules that I wrote for my projects and GitHub community.",
  ...
  },
  {
      ...
      "tags" : [
        {"name":"jquery", "color":"#96C96D"}
      ]
  },
  {
      "title" : "Collision Game",
      "description" : "Built with LibGDX Game Engine. I have written my own framework over LibGDX. The aim of the game is to avoid collision with red balls as long as you can.",
